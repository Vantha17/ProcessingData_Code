...
new_model1 = tf.keras.models.load_model('ANN_M1.h5')
new_model2 = tf.keras.models.load_model('ANN_M2.h5')
new_model3 = tf.keras.models.load_model('ANN_M3.h5')
new_model4 = tf.keras.models.load_model('ANN_M4.h5')
new_model5 = tf.keras.models.load_model('ANN_M5.h5')
new_model6 = tf.keras.models.load_model('ANN_M6.h5')
